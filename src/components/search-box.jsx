...
export default function SearchBox({
  ...
  return (
    <div
      className={`w-full relative flex items-center border rounded bg-[#f3f3f3] text-zinc-700 z-30`}
    >
      <button
        className=" text-zinc-500 px-4 py-2 rounded-r-lg"
        onClick={() => {
          selectedSuggestion
      ...
      <input
        ...
        onFocus={() => handleFocus()}
        ref={inputRef}
        className="w-full text-md bg-[#f3f3f3] rounded-full !focus-visible:outline-none focus:outline-none border-none   py-2 "
      />
      {query && (
        <button
          onClick={clearQuery}
